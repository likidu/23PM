...
class QueriesObserver extends subscribable_1.Subscribable {
    ...
    getObserver(options) {
        ...
        return currentObserver !== null && currentObserver !== void 0 ? currentObserver : new queryObserver_1.QueryObserver(this.client, defaultedOptions);
    }
