...
class QueryObserver extends subscribable_1.Subscribable {
    ...
    updateOptions(options, notifyOptions) {
        ...
        if (options.queryKey && !options.queryHash && options.queryKey !== this.options.queryKey) {
            mergedOptions.queryHash = utils_1.hashQueryKeyByOptions(options.queryKey, mergedOptions);
        }
    ...
    updateStaleTimeout() {
        ...
        const time = utils_1.timeUntilStale(this.currentResult.dataUpdatedAt, this.options.staleTime);
    ...
    updateRefetchInterval(nextInterval) {
        ...
        if (utils_1.isServer ||
            ...
            !utils_1.isValidTimeout(this.currentRefetchInterval) ||
        ...
        this.refetchIntervalId = setInterval(() => {
            if (this.options.refetchIntervalInBackground ||
                focusManager_1.focusManager.isFocused()) {
                this.executeFetch();
            }
            ...
            if (prevResult &&
                ...
                try {
                    ...
                    if (options.structuralSharing !== false) {
                        data = utils_1.replaceEqualDeep(prevResult === null || prevResult === void 0 ? void 0 : prevResult.data, data);
                    }
                    this.previousSelect = {
                        fn: options.select,
                        result: data,
                    ...
                    logger_1.getLogger().error(selectError);
                    error = selectError;
            ...
            if ((prevResult === null || prevResult === void 0 ? void 0 : prevResult.isPlaceholderData) &&
                ...
                if (options.select && typeof placeholderData !== 'undefined') {
                    try {
                        ...
                        if (options.structuralSharing !== false) {
                            placeholderData = utils_1.replaceEqualDeep(prevResult === null || prevResult === void 0 ? void 0 : prevResult.data, placeholderData);
                        }
                        this.previousSelectError = null;
                    }
                    catch (selectError) {
    ...
    updateResult(notifyOptions) {
        ...
        if (utils_1.shallowEqualObjects(this.currentResult, prevResult)) {
            return;
        }
    ...
    onQueryUpdate(action) {
        ...
        else if (action.type === 'error' && !retryer_1.isCancelledError(action.error)) {
